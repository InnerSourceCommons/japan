...
* すべての専門知識を単一のチームから得る必要はないとエンジニアに教えること。
<!-- textlint-disable -->世界中のどこからでも支援を受けることができるのが OSS である。<!-- textlint-enable -->
OSS プロジェクトにコントリビュートすることで会社の知名度が上がり、積極的に取り組む姿勢をコミュニティに示すことができる。
