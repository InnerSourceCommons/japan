...
そこで、各地域のエンジニアはサンノゼの本社に飛び、1ヶ月間コアチームから直接教えを受けました。
...
多くの企業は、OSS という技術が純粋に高品質で無償であることに魅力とみなしており、それをきっかけにした OSS の採用はコミュニティへの継続的な参入につながると考えています。
...
* すべての専門知識を単一のチームから得る必要はないとエンジニアに教えること。世界中のどこからでも支援を受けることができるのが OSS である。OSS プロジェクトにコントリビュートすることで会社の知名度が上がり、積極的に取り組む姿勢をコミュニティに示すことができる。
